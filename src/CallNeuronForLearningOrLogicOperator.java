...
public class CallNeuronForLearningOrLogicOperator {

    public static void main (String [] args) {
        NeuronLearningLogicOperator neuroun = new NeuronLearningLogicOperator();
        neuroun.trainingByExamples();
        neuroun.learningAnExample(new ExampleLogicOperator(new double[]{0, 1}), "1");
        ...
        neuroun.learningAnExample(new ExampleLogicOperator(new double[]{1, 0}), "1");
     }
}
